...
def show_history(limit=None):
    ...
    for link in links:
        ...
        print(f"{link_id:<5} {original_display:<40} {shortened:<30} {alias_display:<15} {created:<20}")
...
Examples:
  ...
  linkfy --last
    ...
    parser.add_argument('--copy', '-c', action='store_true', help='Copy shortened URL to clipboard')
    parser.add_argument('--history', action='store_true', help='Show history of shortened URLs')
